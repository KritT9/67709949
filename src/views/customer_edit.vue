    ...
    <table class="table table-bordered table-striped">
      ...
      <tbody>
        <tr v-for="customer in customers" :key="customer.customer_id">
          ...
          <td>
            <button class="btn btn-warning btn-sm" @click="openEditModal(customer)"><i class="fa-solid fa-user-pen"></i>
            </button>
            |
            <button class="btn btn-danger btn-sm" @click="deleteCustomer(customer.customer_id)"><i class="fa-solid fa-user-pen"></i>
            </button>
          </td>
        </tr>
      </tbody>
...
export default {
  ...
  setup() {
    ...
    const fetchCustomers = async () => {
      try {
        const response = await fetch("http://localhost:8081/67709949/api_php/api_customer.php");
    ...
    const saveCustomer = async () => {
      const url = "http://localhost:8081/67709949/api_php/api_customer.php";
