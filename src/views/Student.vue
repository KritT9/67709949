<template>
  <div class="container mt-4">
    ...
    <div class="mb-3">
      <a class="btn btn-primary" href="/add_Stud" role="button">Add+</a>
    </div>
...
export default {
  ...
  setup() {
    ...
    const fetchStudents = async () => {
      try {
        const response = await fetch("http://localhost:8081/67709949/api_php/Show_student.php", {
          method: "GET",
          headers: {
...
const deleteStudent = async (id) => {
  ...
  try {
    const response = await fetch("http://localhost:8081/67709949/api_php/api_student.php", {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json"
      },
