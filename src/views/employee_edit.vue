<template>
  <div class="container mt-4">
    ...
    <div class="mb-3">
      <a class="btn btn-primary" href="/add_Emp" role="button">Add+</a>
    </div>
    ...
    <table class="table table-bordered table-striped">
      ...
      <tbody>
        <tr v-for="employee in employees" :key="employee.employee_id">
          ...
          <td>
                <img :src="'http://localhost:8081/67709949/api_php/uploads/' + employee.image"
            width="200" 
            height="150"
            :alt="employee_name">
          </td>
...
export default {
  ...
  setup() {
    ...
    const fetchEmployees = async () => {
      try {
        const res = await fetch("http://localhost:8081/67709949/api_php/employee.php");
